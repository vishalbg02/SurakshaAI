        ...
        <nav className="sticky top-0 z-50 glass border-b border-cx-border/40">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-2.5 group">
              ...
              <span className="text-[15px] font-bold text-cx-text tracking-tight">Suraksha<span className="text-cx-accent">AI</span></span>
            </Link>
            <div className="flex items-center gap-0.5">
              {[
                ...
                <Link key={l.href} href={l.href} className="px-3 py-1.5 text-[13px] text-cx-textSec hover:text-cx-text rounded-lg hover:bg-cx-card transition-all duration-200">
                  {l.label}
                </Link>
              ))}
            </div>
